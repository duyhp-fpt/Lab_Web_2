...
public class FilterDispatcher implements Filter {
    ...
    private final String URLERROR = "C:\\Users\\Administrator\\Documents\\NetBeansProjects\\Assignment2_HuynhPhucDuy";
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            List<String> listLectureFunction = (List<String>) context.getAttribute("LECTURE");
            List<String> listStudentFunction = (List<String>) context.getAttribute("STUDENT");
            if (!resource.isEmpty()) {
            ...
            if (session == null) {
                ...
                if (currentUser == null) {
                    isLecture = false;
                } else if (!currentUser.getRole().equals("Lecture")) {
                    isLecture = false;
                }
                if (currentUser == null) {
                    isStudent = false;
            ...
            if (!isStudent) {
                if (isLecture == false) {
                    if (listLectureFunction.contains(resource)) {
                        HttpServletResponse res = (HttpServletResponse) response;
                        res.sendRedirect("index");
                    }
                } else {
                    if (listStudentFunction.contains(resource)) {
                        HttpServletResponse res = (HttpServletResponse) response;
                        res.sendRedirect("index");
                    }
                }
            ...
            Logger.getLogger(FilterDispatcher.class.getName()).error(t.toString());
        }
    }
